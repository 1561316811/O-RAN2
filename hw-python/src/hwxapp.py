...
from ricxappframe.logger.mdclogger import Level
...
class HWXapp:
    ...
    def __init__(self):
        ...
        print('DBAAS_SERVICE_HOST', getenv('DBAAS_SERVICE_HOST'))
